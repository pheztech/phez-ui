...
var TimeField = function (_a) {
    ...
    return (react_1.default.createElement("label", { className: className },
        ...
        react_1.default.createElement("input", __assign({ className: style, type: 'time', name: field.name }, props, { value: date.toISOString().substring(11, 16), onChange: function (e) { return form.setFieldValue(field.name, getOffset(e.target.valueAsDate)); }, onBlur: field.onBlur })),
