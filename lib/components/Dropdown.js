...
var Dropdown = function (_a) {
    var label = _a.label, children = _a.children, className = _a.className, position = _a.position, fullWidth = _a.fullWidth, props = __rest(_a, ["label", "children", "className", "position", "fullWidth"]);
    ...
    return (react_2.default.createElement("div", { className: wrapperStyle },
        react_2.default.createElement("button", __assign({ id: 'dropdown-menu', onClick: toggle, ref: buttonRef, "aria-expanded": 'false', "aria-haspopup": 'true', className: className, children: label }, props)),
